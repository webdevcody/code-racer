...
export default function MultiplayerLoadingLobby({ participants, children }: MultiplayerLoadingLobbyProps) {
  ...
  return (
    <div className="flex flex-col items-center space-y-10">
      ...
      <div className="flex justify-center space-x-10">
        {/* {lobby && lobby} */}
        {lobby && lobby.map(( participant, idx ) => <LobbyUser key={idx} participant={participant} />)}
      </div>
      {children}
    </div>
  )
