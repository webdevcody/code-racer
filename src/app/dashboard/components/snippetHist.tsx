...
import { XAxis, YAxis, Tooltip, ResponsiveContainer, Scatter, ScatterChart, ZAxis, TooltipProps } from "recharts";
import {
    NameType,
    ValueType,
...
function getCustomisedData(data: Snippet[]) {
    ...
    const dataCustomised = Object.entries(languageCounts).map(([language, count]) => {
        return {
            language,
            count
        };
...
export function SnippetsHist({ data }: RecentSnippetsTableProps) {
