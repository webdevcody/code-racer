...
export async function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 flex w-full dark:shadow-black shadow-slate-300 dark:bg-slate-800 dark:bg-opacity-50 bg-background/10 backdrop-blur-md">
